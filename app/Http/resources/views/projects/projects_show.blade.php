...
@section('content')
    <div class="row" style="margin:25px; margin-bottom: 25px; padding-right:10px">
        <?php   
            $colspan = 3;
        ?>
        <div style="background-color:#2c2c2c; padding:5px; margin-right: 10px" class="col-md-8">
    ...
    <div class="row" style="margin:25px; margin-bottom: 200px;padding-right:10px">
        ...
        <div style="margin-right:10px; background-color:#2c2c2c; padding:5px;" class="col-md-5">
            <table style="width:100%">
                <th colspan="{{$colspan}}" 
        ...
        <div style="padding:0; background-color:#2c2c2c; padding:5px;" class="col-md-6">
            <table style="width:100%">
                <th colspan="{{$colspan}}" 
                    style="padding:10px;border-bottom:3px solid #5f4a3d;background-color: #212121">
                    All Other RFI's
