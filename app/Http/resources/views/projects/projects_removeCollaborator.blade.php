...
<div class="row" style="margin:25px; margin-bottom: 200px;">
    ...
    <div style="padding:0; background-color:#2c2c2c; padding:5px;" class="col-md-6 col-md-offset-3">
        <table style="width:100%">
            ...
            @else
                <tr><td style="text-align:center;padding-top:5px;font-weight:bolder; color:black" colspan="{{$colspan}}">No enabled users found that can be removed from project</td></tr>
            @endif
